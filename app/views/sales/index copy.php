...
<div class ="col-md-12 col-12">
                    ...
                    <div class="row col-md-2" style="width:18%;">  
                      ...
                      <div class="row col-md-4" style="width:18%;">  
                        ...
                        <div style="width:15%;"  class="col-sm-2">
                                    <button  type="sumbit" name="sumbit" class=" btnsumbit btn btn-primary me-1 mb-3" id="Createdata">Sumbit</button>
                                  </div>
                </div>
  ...
  <link rel="stylesheet" href="https://printjs-4de6.kxcdn.com/print.min.cs" />
<script>
...
function setTanggalAwalAkhir(tahun,bulan){
        ...
        Tabeldata +=`
          <table id="Tabel1" styles="font-size: 8px;" class="display table-hover table-info" style='width:100%'>                    
                                                    ...
                                                    <tr>
                                                                ...
                                                                <td style="width:11%" rowspan="3" class="text-center">HARI</td>
   ...
   Tabeldata +=`
    ...
    Tabeldata +=`
              ...
              <td colspan="2" class="barisfootkiri gratoalbawah"></td>
         
              <td class="barisfoottengah text-end gratoalbawah"> ${responses.garand_total}&nbsp;&nbsp;</td>
              <td class="barisfoottengah gratoalbawah"></td>
              <td class="barisfoottengah gratoalbawah"></td>
              <td class="barisfootkanan gratoalbawah"></td>
              <td class="nobaris"></td>
    ...
    Tabeldata +=`
              ...
              <td colspan="2" class="barisfootkiri gratoalbawah"></td>
              <td class="barisfoottengah text-end gratoalbawah">${responses.total_target}&nbsp;&nbsp;</td>
              <td class="barisfoottengah gratoalbawah"></td>
              <td class="barisfoottengah gratoalbawah"></td>
              <td class="barisfootkanan gratoalbawah"></td>
               <td class="nobaris"></td>
   ...
   setrowspandata();
    ...
    function setrowspandata(){
      ...
      table.find('tr').each(function(index,row){
        let currentTh = $(row).find('th:first');
        console.log(currentTh)
        if (previousText === currentTh.text()) {
            rowspan++;
            currentTh.remove(); // Hapus <th> yang sama
        } else {
          if (rowspan > 1) {
            $(row).prev().find('th:first').attr('rowspan', rowspan);
          }
          previousText = currentTh.text();
          rowspan = 1;
        }

        if (rowspan > 1) {
          table.find('tr:last').find('th:first').attr('rowspan', rowspan);
        }
      })
    }
